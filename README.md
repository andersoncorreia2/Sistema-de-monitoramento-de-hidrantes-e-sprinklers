...
![Tela Principal do Painel](imagens/foto-painel.png)

![Painel de Gestão de Efetivo](imagens/foto-gestao.png)

![Tela de Cadastro de Efetivo](imagens/foto-cadastro.png)
